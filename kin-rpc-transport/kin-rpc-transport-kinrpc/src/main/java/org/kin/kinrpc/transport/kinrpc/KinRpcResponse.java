...
public class KinRpcResponse extends SocketProtocol {
    /** request唯一id */
    ...
    public static KinRpcResponse create(long requestId, byte serializer, byte[] respContent) {
        KinRpcResponse protocol = ProtocolFactory.createProtocol(KinRpcProtocolId.RPC_RESPONSE_PROTOCOL_ID);
