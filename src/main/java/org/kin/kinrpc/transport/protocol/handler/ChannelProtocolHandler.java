...
import org.kin.kinrpc.utils.ChannelUtils;
...
public class ChannelProtocolHandler extends ChannelInboundHandlerAdapter {
    ...
    public ChannelProtocolHandler(org.kin.kinrpc.transport.protocol.ProtocolHandler protocolHandler, SessionBuilder sessionBuilder) {
        this(protocolHandler, sessionBuilder, null, null, null);
    }

    public ChannelProtocolHandler(org.kin.kinrpc.transport.protocol.ProtocolHandler protocolHandler,
                                  SessionBuilder sessionBuilder,
                                  ChannelActiveListener channelActiveListener) {
